...
# Access token
client_id = '6ba77412410b46778b83e5b9dcfe7d0a'
client_secret = 'e85d9f000a024f8b87460f847d4c54d9'
...
def main():
  # Dataset that has moods for spotify songs
  df = pd.read_csv('../csv_files/mood.csv')

  # Slicing mood dataset
  df = df[:num]

  print(df) # Prints the sliced dataset

  # Length of the mood dataset
  print(len(df)) # Prints the length of the sliced mood dataset

  # Length of the spotify id in the mood dataset
  ...
  data.to_csv('../csv_files/spotify_api_mood.csv') # Saves the data in .csv format
